// ENGINE differential test — derived from diff_test.cpp (same trials, seeds, and
// comparison logic). Where diff_test pits the native original against the hand-ported
// C function, this file pits the native original against the SAME original code run
// through the x86 interpreter (tj::engine), reached via the EF<> gate.
//
...
static int kTrials        = 2000;   // runtime-overridable via env var TJ_ENG_TRIALS
...
void Run_72670() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *reinterpret_cast<int32_t*>(b.data() + 4) = reinterpret_cast<int32_t>(subB.data());
        ...
        uint32_t rb = EF<OrigFn>(0x00072670)(reinterpret_cast<int>(b.data()));
...
void Run_111f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float ra = orig(v), rb = EF<OrigFn>(0x000111f0)(v);
...
void Run_112f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        orig(oa, m, v); EF<OrigFn>(0x000112f0)(ob, m, v);
...
void Run_112b0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float oa[3] = {}, ob[3] = {};
        orig(oa, a, b); EF<OrigFn>(0x000112b0)(ob, a, b);
...
void Run_12050() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)Dat(0xF57D0) = idxSave;
        float rb = EF<OrigFn>(0x00012050)(0);
...
void Run_2eab0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x258) = RandF() / 1000.0f * 720.0f;
        ...
        EF<OrigFn>(0x0002eab0)(reinterpret_cast<int>(b.data()));
        int bad = -1;
...
void Run_117b0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        orig(oa, a, b); EF<OrigFn>(0x000117b0)(ob, a, b);
        int bad = -1;
...
void Run_2f5b0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0002f5b0)(reinterpret_cast<int>(b.data()));
...
void Run_2e110() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float oa[16] = {}, ob[16] = {};
        orig(oa, eye, tgt, up); EF<OrigFn>(0x0002e110)(ob, eye, tgt, up);
...
void Run_2e7f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)Dat(0xF57D0) = idx;
        EF<OrigFn>(0x0002e7f0)(reinterpret_cast<int>(b.data()));
...
void Run_2e6d0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x1e4) = (uint32_t)(uintptr_t)ptB;
        ...
        uint32_t ra, rb = EF<OrigFn>(0x0002e6d0)(reinterpret_cast<int>(a.data()));
...
void Run_2eca0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)Dat(0x16A270) = RandF();
        ...
        EF<OrigFn>(0x0002eca0)(reinterpret_cast<int>(b.data()));
...
void Run_2e3e0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)Dat(0x16A280) = 10.0f + (g_rng() % 50);
        ...
        uint32_t ra, rb = EF<OrigFn>(0x0002e3e0)(reinterpret_cast<int>(b.data()), idx);
...
void Run_2f0f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x160) = C(); *(float*)(a.data() + 0x168) = C(); // limb B x,z
        ...
        EF<OrigFn>(0x0002f0f0)(reinterpret_cast<int>(b.data()));
        int bad = -1; double w = CompareTol(a.data(), b.data(), kStructSize, 1e-3, &bad);
        if (w > worst) worst = w;
    ...
    *(float*)Dat(0x16A278) = 30.0f; *(float*)Dat(0x16A280) = 30.0f;
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data()+0x1e4) = (uint32_t)(uintptr_t)ptB;
        ...
        EF<OrigFn>(0x0002fce0)(reinterpret_cast<int>(b.data()));
...
void Run_88e90() {
    ...
    if (orig(0) != EF<OrigFn>(0x00088e90)(0)) { printf("  [FAIL] F_00088e90 (null)\n"); ++g_fail; return; }
    std::vector<uint8_t> a(kStructSize);
    for (int t = 0; t < kTrials; ++t) {
        Randomize(a.data(), kStructSize);
        int self = reinterpret_cast<int>(a.data());
        if (orig(self) != EF<OrigFn>(0x00088e90)(self)) { printf("  [FAIL] F_00088e90 trial %d\n", t); ++g_fail; return; }
    }
...
void RunVoidThisFloat(const char* name, uint32_t va, void(__thiscall* port)(int, float)) {
...
uint32_t __fastcall Wrap_1b0c0(int self, int p2) { return EF<uint32_t(__thiscall*)(int, int)>(0x0001b0c0)(self, p2); }
...
void Run_37b20() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x834) = (uint32_t)(uintptr_t)sub.data();
        ...
        EF<OrigFn>(0x00037b20)(reinterpret_cast<int>(b.data()));
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_46150() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x0c) = RandF() / 10.0f;
        ...
        EF<OrigFn>(0x00046150)(reinterpret_cast<int>(b.data()));
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_45a30() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x18) = RandF() / 10.0f;
        ...
        EF<OrigFn>(0x00045a30)(reinterpret_cast<int>(b.data()), arg);
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_30360() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x00030360)(reinterpret_cast<int>(a.data()));
...
void RunBoxTest(const char* name, uint32_t va, uint32_t(__stdcall* port)(const float*)) {
...
void Run_380f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x848) = (uint32_t)(uintptr_t)&slot;
        uint32_t ra, rb = EF<OrigFn>(0x000380f0)(reinterpret_cast<int>(a.data()));
        if (!CallU32FastGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_38670() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x834) = (uint32_t)(uintptr_t)subB.data();
        int arg = (int)(g_rng() & 1);
        uint32_t ra, rb = EF<OrigFn>(0x00038670)(reinterpret_cast<int>(a.data()), arg);
        if (!CallU32ThisGuarded(orig, reinterpret_cast<int>(a.data()), arg, &ra)) {
...
void Run_302e0() {
    ...
    for (int t = 0; t < kTrials / 4; ++t) {     // big memcmp; quarter trials is plenty
        ...
        *(uint32_t*)(a.data() + 0x1fe0) = (uint32_t)(uintptr_t)list.data();
        ...
        EF<OrigFn>(0x000302e0)(reinterpret_cast<int>(b.data()));
...
void Run_34ab0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x13f8) = (uint32_t)(uintptr_t)sub.data();
        uint32_t ra, rb = EF<OrigFn>(0x00034ab0)(reinterpret_cast<int>(a.data()));
        if (!CallU32StdGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_3d170() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0003d170)(reinterpret_cast<int>(b.data()), (int)(uintptr_t)src.data());
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_43e50() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x4b8) = (uint32_t)(uintptr_t)boxsrc.data();
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x00043e50)(reinterpret_cast<int>(b.data()), idx);
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_47d40() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x478) = (uint32_t)(uintptr_t)boxes.data();
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t rb = EF<OrigFn>(0x00047d40)(reinterpret_cast<int>(a.data()), p);
        struct Guard {
...
void Run_62a70() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)Dat(0xF57D0) = g_rng() % 0x270;
        ...
        memcpy(Dat(0x183580), stSave.data(), kStateBytes);
        *(uint32_t*)Dat(0xF57D0) = idxSave;
        EF<OrigFn>(0x00062a70)(reinterpret_cast<int>(b.data()), idx);
        if (memcmp(a.data(), b.data(), kStructSize) != 0 ||
            memcmp(postState.data(), Dat(0x183580), kStateBytes) != 0 ||
            postIdx != *(uint32_t*)Dat(0xF57D0)) {
            int firstOff = -1;
...
void Run_15040() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x00015040)((int)(uintptr_t)table, q);
...
void Run_1b290() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        memcpy(lvlPost.data(), g_world->level.data(), lvlPost.size());
        memcpy(g_world->level.data(), lvlSave.data(), lvlSave.size());
        EF<OrigFn>(0x0001b290)(reinterpret_cast<int>(b.data()));
        if (memcmp(a.data(), b.data(), kStructSize) != 0 ||
            memcmp(lvlPost.data(), g_world->level.data(), lvlPost.size()) != 0) {
...
void Run_45b70() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x2c) = RandF() / 100.0f;
        ...
        EF<OrigFn>(0x00045b70)(reinterpret_cast<int>(b.data()));
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_2e0b0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)Dat(0x15C4710) = (t & 1) ? g_rng() : (tv ? tv - (g_rng() % 10000) : 0);
        ...
        uint32_t rb = EF<OrigFn>(0x0002e0b0)(bufB, tv);
...
void Run_135f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x04) = (uint32_t)(uintptr_t)ptrs;
        ...
        EF<OrigFn>(0x000135f0)((int)(uintptr_t)b.data(), flag);
...
void Run_11c40() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x00011c40)((int)(uintptr_t)selfM, outB, m[0], m[1], m[2], m[3], m[4], m[5], m[6], m[7], m[8]);
...
void Run_2d410() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra = orig(reinterpret_cast<int>(a.data()));
        uint32_t rb = EF<OrigFn>(0x0002d410)(reinterpret_cast<int>(b.data()));
...
void Run_386f0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x84c) = (uint32_t)(uintptr_t)sub.data();
        ...
        EF<OrigFn>(0x000386f0)(reinterpret_cast<int>(b.data()), arg);
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_46590() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x00046590)(reinterpret_cast<int>(b.data()));
        if (memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_72130() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(self + 8) = (uint32_t)(uintptr_t)(arr.data() + n * 0x4c);
        ...
        uint32_t rb = EF<OrigFn>(0x00072130)((int)(uintptr_t)self, &outB);
...
void Run_59960() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t rb = EF<OrigFn>(0x00059960)(reinterpret_cast<int>(b.data()), arg);
        if ((ra & 0xff) != (rb & 0xff) || memcmp(a.data(), b.data(), kStructSize) != 0) {
...
void Run_465e0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 12) = (uint32_t)(uintptr_t)s1.data();
        uint32_t ra, rb = EF<OrigFn>(0x000465e0)(reinterpret_cast<int>(a.data()));
        if (!CallU32FastGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_14fb0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        g_v11N = 0;
        EF<OrigFn>(0x00014fb0)(reinterpret_cast<int>(b.data()));
    ...
    *(uint32_t*)child = (uint32_t)(uintptr_t)childVt;
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data()) = (uint32_t)(uintptr_t)selfVt;   // self vtable
        ...
        int nA = g_v11N; uint32_t logA[128]; memcpy(logA, g_v11Log, sizeof logA);
        g_v11N = 0;
        EF<OrigFn>(0x00014ff0)(reinterpret_cast<int>(b.data()));
        if (nA != g_v11N || memcmp(logA, g_v11Log, nA * 4) != 0 ||
            memcmp(a.data(), b.data(), 0x100) != 0) {
...
void Run_45b20() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float rb = EF<OrigFn>(0x00045b20)(reinterpret_cast<int>(a.data()), arg);
        if (memcmp(&ra, &rb, 4) != 0) {
...
void Run_2db80() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint8_t rb = (uint8_t)EF<OrigFn>(0x0002db80)(row, match);
        if ((ra & 0xff) != rb) {
...
void Run_11260() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float ra = orig(a);
        float rb = EF<OrigFn>(0x00011260)(b);
        int bad = -1;
...
void Run_31170() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x1c8f0) = (uint32_t)(uintptr_t)rej.data();
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        p[0] = RandF(); p[1] = RandF(); p[2] = RandF();
        uint32_t ra = orig(p);
        uint8_t rb = (uint8_t)EF<OrigFn>(0x00031170)(p);
        if ((ra & 0xff) != rb) {
...
void Run_151e0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x000151e0)(reinterpret_cast<int>(a.data()));
        if (!CallU32FastGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_38850() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x834) = (uint32_t)(uintptr_t)sub.data();
        ...
        EF<OrigFn>(0x00038850)(reinterpret_cast<int>(b.data()));
...
void Run_1bad0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0001bad0)(reinterpret_cast<int>(b.data()), arg);
        for (int i = 0; i < 11; ++i)
...
void Run_3fbf0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0003fbf0)(reinterpret_cast<int>(b.data()), src);
...
void Run_2f0c0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0002f0c0)(reinterpret_cast<int>(b.data()), arg);
...
void Run_13430() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 4) = (uint32_t)(uintptr_t)ptrs;
        int mask = (int)g_rng();
        uint32_t ra, rb = EF<OrigFn>(0x00013430)(reinterpret_cast<int>(a.data()), mask);
...
void Run_6fd20() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x0006fd20)(reinterpret_cast<int>(a.data()), key);
    ...
    *(uint32_t*)child = (uint32_t)(uintptr_t)childVt;
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data()) = (uint32_t)(uintptr_t)selfVt;
        ...
        g_v11N = 0;
        EF<OrigFn>(0x00015420)(reinterpret_cast<int>(b.data()));
        if (nA != g_v11N || memcmp(logA, g_v11Log, nA * 4) != 0 ||
...
void Run_15180() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        g_v11N = 0;
        EF<OrigFn>(0x00015180)(reinterpret_cast<int>(b.data()));
        if (nA != g_v11N || memcmp(logA, g_v11Log, nA * 4) != 0 ||
...
void Run_47b30() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x478) = (uint32_t)(uintptr_t)boxes.data();
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint8_t rb = (uint8_t)EF<OrigFn>(0x00047b30)(p, outB);
...
void Run_11bd0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        float ra = orig(a, b);
        float rb = EF<OrigFn>(0x00011bd0)(a, b);
        if (memcmp(&ra, &rb, 4) != 0) {
...
void RunBroadcast(const char* name, uint32_t va, void(__thiscall* port)(int, int),
                  int childOff) {
    using OrigFn = void(__thiscall*)(int, int);
    OrigFn orig = Orig<OrigFn>(va);
    std::vector<uint8_t> a(kStructSize), b(kStructSize);
...
void Run_43f60() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x40) = (uint32_t)(uintptr_t)child.data();
        ...
        uint32_t ra, rb = EF<OrigFn>(0x00043f60)(reinterpret_cast<int>(a.data()), pB);
        if (!CallU32ThisGuarded((uint32_t(__thiscall*)(int, int))orig,
...
void Run_34a80() {
    ...
    for (int t = 0; t < kTrials / 4; ++t) {
        Randomize(a.data(), sz);
        int key = (int)(g_rng() & 0xff);
        uint32_t ra, rb = EF<OrigFn>(0x00034a80)(reinterpret_cast<int>(a.data()), key);
        if (!CallU32ThisGuarded(orig, reinterpret_cast<int>(a.data()), key, &ra)) {
...
void Run_488c0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t rb = EF<OrigFn>(0x000488c0)(reinterpret_cast<int>(b.data()), (int)(uintptr_t)src.data());
        if (ra - (uint32_t)(uintptr_t)a.data() != rb - (uint32_t)(uintptr_t)b.data() ||
...
void Run_302b0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 4) = RandF() / 100.0f;
        ...
        EF<OrigFn>(0x000302b0)(reinterpret_cast<int>(b.data()));
...
void Run_46120() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(float*)(a.data() + 0x24) = RandF() / 10.0f;
        ...
        EF<OrigFn>(0x00046120)(reinterpret_cast<int>(b.data()), arg);
...
void Run_133d0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 4) = (uint32_t)(uintptr_t)ptrs;
        ...
        int nA = g_v11N; uint32_t logA[128]; memcpy(logA, g_v11Log, sizeof logA);
        g_v11N = 0;
        uint32_t rb = EF<OrigFn>(0x000133d0)(reinterpret_cast<int>(a.data()));
...
void Run_1a5a0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0xe8) = (uint32_t)(uintptr_t)vt;
        ...
        int nA = g_v11N; uint32_t logA[128]; memcpy(logA, g_v11Log, sizeof logA);
        g_v11N = 0;
        EF<OrigFn>(0x0001a5a0)(reinterpret_cast<int>(a.data()));
        if (nA != g_v11N || memcmp(logA, g_v11Log, nA * 4) != 0) {
...
void Run_1da80() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        int nA = g_v11N; uint32_t logA[128]; memcpy(logA, g_v11Log, sizeof logA);
        g_v11N = 0;
        EF<OrigFn>(0x0001da80)(reinterpret_cast<int>(b.data()));
...
void Run_33e00() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x1c8e8) = (uint32_t)(uintptr_t)tsObj.data();
    ...
    for (int t = 0; t < kTrials / 8; ++t) {
        ...
        EF<OrigFn>(0x00033e00)(reinterpret_cast<int>(b.data()), arg);
...
void Run_47dd0() {
    ...
    *(uint32_t*)(g_world->world.data() + 0x478) = (uint32_t)(uintptr_t)boxes.data();
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        p[0] = RandF(); p[1] = RandF(); p[2] = RandF();
        uint32_t ra = orig(p);
        uint8_t rb = (uint8_t)EF<OrigFn>(0x00047dd0)(p);
...
void Run_40170() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x00040170)(reinterpret_cast<int>(b.data()), src);
...
void Run_322c0() {
    ...
    for (int t = 0; t < kTrials / 8; ++t) {
        ...
        EF<OrigFn>(0x000322c0)(reinterpret_cast<int>(b.data()), arg);
...
void Run_66f20() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(a.data() + 0x20) = g_rng() % 200;   // bound the loop
        ...
        EF<OrigFn>(0x00066f20)(reinterpret_cast<int>(b.data()));
...
void Run_720c0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint8_t rb = (uint8_t)EF<OrigFn>(0x000720c0)(&slot);
...
void Run_14f80() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra = orig(reinterpret_cast<int>(a.data()));
        uint32_t rb = EF<OrigFn>(0x00014f80)(reinterpret_cast<int>(b.data()));
        if (ra != (uint32_t)(uintptr_t)a.data() || rb != (uint32_t)(uintptr_t)b.data() ||
...
void RunRosterLookup(const char* name, uint32_t va, uint32_t(__cdecl* port)(uint32_t)) {
...
void Run_11aa0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        if (t % 21 == 0) a[2] = 0;
        float ra = orig(a);
        float rb = EF<OrigFn>(0x00011aa0)(a);
        if (memcmp(&ra, &rb, 4) != 0) {
            double rel = std::abs((double)ra - rb) / (std::abs((double)ra) > 1 ? std::abs((double)ra) : 1);
            if (rel > worst) worst = rel;
...
void Run_6b170() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint8_t rb = (uint8_t)EF<OrigFn>(0x0006b170)(shape, p);
...
void Run_19d30() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x00019d30)(reinterpret_cast<int>(b.data()), src);
...
void Run_32250() {
    ...
    for (int t = 0; t < kTrials / 8; ++t) {
        ...
        EF<OrigFn>(0x00032250)(reinterpret_cast<int>(b.data()), arg);
...
template <class PortFn>
void RunListWalk(const char* name, uint32_t va, PortFn port, int nextOff,
...
void Run_72070() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(ent.data() + 0x44) = entRefA;   // restore for port run
        EF<OrigFn>(0x00072070)(reinterpret_cast<int>(b.data()), src);
        if (memcmp(a.data(), b.data(), kStructSize) != 0 ||
...
void Run_70cd0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x00070cd0)(reinterpret_cast<int>(a.data()));
        if (!CallU32FastGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_3d630() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        EF<OrigFn>(0x0003d630)(reinterpret_cast<int>(b.data()), arg);
...
void Run_1e120() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        uint32_t ra, rb = EF<OrigFn>(0x0001e120)(reinterpret_cast<int>(b.data()));
        if (!CallU32FastGuarded(orig, reinterpret_cast<int>(a.data()), &ra)) {
...
void Run_1d2c0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(self.data() + 0x14) = len ? (uint32_t)(uintptr_t)nodes[0].data() : 0u;
        ...
        int nA = g_v11N; uint32_t logA[128]; memcpy(logA, g_v11Log, sizeof logA);
        g_v11N = 0;
        uint32_t rb = EF<OrigFn>(0x0001d2c0)(reinterpret_cast<int>(self.data()));
...
void Run_38080() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(b.data() + 0x89c) = (uint32_t)(uintptr_t)vecB;
        ...
        EF<OrigFn>(0x00038080)(reinterpret_cast<int>(b.data()), arg);
        int bad = -1;
...
void Run_37fa0() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        ...
        *(uint32_t*)(b.data() + 0x848) = (uint32_t)(uintptr_t)gate;
        ...
        EF<OrigFn>(0x00037fa0)(reinterpret_cast<int>(b.data()));
        int bad = -1;
        double w = CompareTol((uint8_t*)vecA, (uint8_t*)vecB, 12, 1e-5, &bad);
...
int main() {
    ...
    // Trial-count override (the interpreter is far slower than native execution).
    char trialsEnv[32];
    if (GetEnvironmentVariableA("TJ_ENG_TRIALS", trialsEnv, sizeof trialsEnv) > 0) {
        int v = atoi(trialsEnv);
        if (v > 0) { kTrials = v; printf("TJ_ENG_TRIALS override: %d trials\n", kTrials); }
    }
    ...
    // The images are RELOCATED in this process: the gate must translate its entry VA
    // the same way Orig() does. (The hybrid maps true VAs and skips this.)
    tj::engine::EngineSetCodeMap(&tj::game::OriginalCode);

    printf("ENGINE differential test: original .text native vs interpreted, %d trials each\n\n", kTrials);

    RunVoid("F_00011000", 0x00011000, EF<decltype(&F_00011000)>(0x00011000));
    RunVoid("F_00011020", 0x00011020, EF<decltype(&F_00011020)>(0x00011020));
    RunPred<uint32_t>("F_00016e80", 0x00016e80, EF<decltype(&F_00016e80)>(0x00016e80));
    RunVoid("F_0002ea80", 0x0002ea80, EF<decltype(&F_0002ea80)>(0x0002ea80));
    RunVoid("F_0002f680", 0x0002f680, EF<decltype(&F_0002f680)>(0x0002f680));
    RunPred<uint8_t>("F_0003f7d0", 0x0003f7d0, EF<decltype(&F_0003f7d0)>(0x0003f7d0), /*forceStates=*/true);
    RunPred<uint8_t>("F_00037b00", 0x00037b00, EF<decltype(&F_00037b00)>(0x00037b00), /*forceStates=*/true);
    RunVoid("F_00014ea0", 0x00014ea0, EF<decltype(&F_00014ea0)>(0x00014ea0));
    RunVoid("F_00019990", 0x00019990, EF<decltype(&F_00019990)>(0x00019990));
    RunVoid("F_00019bd0", 0x00019bd0, EF<decltype(&F_00019bd0)>(0x00019bd0));
    RunVoid("F_000461e0", 0x000461e0, EF<decltype(&F_000461e0)>(0x000461e0));
    RunVoid("F_00048610", 0x00048610, EF<decltype(&F_00048610)>(0x00048610));
    RunVoid("F_0005a010", 0x0005a010, EF<decltype(&F_0005a010)>(0x0005a010));
    Run_72670();
    Run_88e90();
    ...
    RunRng<uint32_t>("F_00011f20", 0x00011f20, EF<decltype(&F_00011f20)>(0x00011f20));
    Run_12050();
    Run_11220();
    ...
    RunVoidWorld("F_000241c0", 0x000241c0, EF<decltype(&F_000241c0)>(0x000241c0));
    Run_37b20();
    RunVoidRngShuffle("F_00030ea0", 0x00030ea0, EF<decltype(&F_00030ea0)>(0x00030ea0), 0x1d8d, /*avoidOne=*/false);
    RunVoidRngShuffle("F_00030f30", 0x00030f30, EF<decltype(&F_00030f30)>(0x00030f30), 0x1da2, /*avoidOne=*/true);
    Run_46150();
    RunVoidThisFloat("F_00071fd0", 0x00071fd0, EF<void(__thiscall*)(int, float)>(0x00071fd0));
    Run_30360();
    RunBoxTest("F_00047c20", 0x00047c20, EF<uint32_t(__stdcall*)(const float*)>(0x00047c20));
    RunBoxTest("F_00047cb0", 0x00047cb0, EF<uint32_t(__stdcall*)(const float*)>(0x00047cb0));
    Run_45a30();
    Run_380f0();
    Run_38670();
    printf("\n  -- batch 9: porting factory (14 fns, agent-ported) --\n");
    RunPredThisArg("F_0001b0c0", 0x0001b0c0, Wrap_1b0c0, 6);
    RunVoidWorld("F_00052d00", 0x00052d00, EF<decltype(&F_00052d00)>(0x00052d00));
    RunVoid("F_00013310", 0x00013310, EF<decltype(&F_00013310)>(0x00013310));
    Run_302e0();
    RunVoidTol("F_000596f0", 0x000596f0, EF<decltype(&F_000596f0)>(0x000596f0), 1e-4);
    RunVoidTol("F_00019c60", 0x00019c60, EF<decltype(&F_00019c60)>(0x00019c60), 1e-5);
    RunVoidThisArg("F_00031250", 0x00031250, EF<void(__thiscall*)(int, int)>(0x00031250), 3);
    Run_34ab0();
    Run_3d170();
    Run_43e50();
    Run_119f0();
    ...
    Run_11750();
    RunVoid("F_000521f0", 0x000521f0, EF<decltype(&F_000521f0)>(0x000521f0));
    RunVoid("F_000707e0", 0x000707e0, EF<decltype(&F_000707e0)>(0x000707e0));
    RunVoidPrep("F_000320f0", 0x000320f0, EF<decltype(&F_000320f0)>(0x000320f0), Prep_320f0);
    RunTreeRotate("F_00070e70", 0x00070e70, EF<void(__thiscall*)(int, int)>(0x00070e70), false);
    RunTreeIter("F_00070f30", 0x00070f30, EF<decltype(&F_00070f30)>(0x00070f30));
    RunTreeRotate("F_00070f90", 0x00070f90, EF<void(__thiscall*)(int, int)>(0x00070f90), true);
    Run_15040();
    RunTreeIter("F_00070ed0", 0x00070ed0, EF<decltype(&F_00070ed0)>(0x00070ed0));
    Run_1b290();
    Run_45b70();
    Run_2e0b0();
    Run_135f0();
    ...
    RunVoid("F_0003fd60", 0x0003fd60, EF<decltype(&F_0003fd60)>(0x0003fd60));
    Run_2d410();
    Run_386f0();
    RunVoidTol("F_000401e0", 0x000401e0, EF<decltype(&F_000401e0)>(0x000401e0), 1e-6);
    Run_46590();
    Run_72130();
    Run_59960();
    Run_465e0();
    ...
    RunVoid("F_00046430", 0x00046430, EF<decltype(&F_00046430)>(0x00046430));
    Run_151e0();
    RunVoidThisArg("F_00045430", 0x00045430, EF<void(__thiscall*)(int, int)>(0x00045430), 256);
    Run_38850();
    Run_1bad0();
    Run_3fbf0();
    Run_2f0c0();
    Run_13430();
    Run_6fd20();
    RunVoid("F_00045af0", 0x00045af0, EF<decltype(&F_00045af0)>(0x00045af0));
    Run_15420();
    Run_15180();
    Run_47b30();
    Run_11bd0();
    printf("\n  -- batch 13: porting factory (14 fns, agent-ported) --\n");
    RunVoid("F_0001a540", 0x0001a540, EF<decltype(&F_0001a540)>(0x0001a540));
    RunBroadcast("F_00013560", 0x00013560, EF<void(__thiscall*)(int, int)>(0x00013560), 0xc0);
    Run_43f60();
    RunBroadcast("F_00013530", 0x00013530, EF<void(__thiscall*)(int, int)>(0x00013530), 0xbf);
    Run_11ba0();
    Run_34a80();
    Run_488c0();
    Run_302b0();
    ...
    Run_40170();
    RunVoid("F_0003d600", 0x0003d600, EF<decltype(&F_0003d600)>(0x0003d600));
    Run_322c0();
    RunVoid("F_00067220", 0x00067220, EF<decltype(&F_00067220)>(0x00067220));
    RunVoid("F_00067620", 0x00067620, EF<decltype(&F_00067620)>(0x00067620));
    RunVoid("F_0001cff0", 0x0001cff0, EF<decltype(&F_0001cff0)>(0x0001cff0));
    Run_66f20();
    Run_720c0();
    Run_36790();
    Run_14f80();
    RunRosterLookup("F_0002d9e0", 0x0002d9e0, EF<uint32_t(__cdecl*)(uint32_t)>(0x0002d9e0));
    RunRosterLookup("F_0002d9b0", 0x0002d9b0, EF<uint32_t(__cdecl*)(uint32_t)>(0x0002d9b0));
    Run_11aa0();
    Run_6b170();
    printf("\n  -- batch 15: porting factory (14 fns, agent-ported) --\n");
    RunVoid("F_00045830", 0x00045830, EF<decltype(&F_00045830)>(0x00045830));
    RunPred<uint8_t>("F_00043f40", 0x00043f40, EF<decltype(&F_00043f40)>(0x00043f40));
    Run_19d30();
    Run_32250();
    RunListWalk("F_00070e30", 0x00070e30, EF<void(__cdecl*)(int)>(0x00070e30), 8, /*cdecl=*/true, /*head=*/8);
    Run_72070();
    Run_70cd0();
    RunVoid("F_0001d010", 0x0001d010, EF<decltype(&F_0001d010)>(0x0001d010));
    Run_3d630();
    Run_1e120();
    Run_1d2c0();
    RunListWalk("F_00070e50", 0x00070e50, EF<void(__cdecl*)(int)>(0x00070e50), 0, /*cdecl=*/true, /*head=*/0);
    Run_38080();
    Run_37fa0();

    printf("\n=== %d passed, %d failed ===\n", g_pass, g_fail);
    uint64_t engInstr = 0, engCalls = 0;
    tj::engine::EngineStats(&engInstr, &engCalls);
    printf("engine: %llu instructions retired, %llu gate calls\n",
           (unsigned long long)engInstr, (unsigned long long)engCalls);
    return g_fail ? 1 : 0;
}
